    ...
    return (
        <div className='w-screen h-screen bg-black/20 backdrop-blur-sm fixed z-[999] flex flex-col justify-end'>
            <div className='h-[550px] bg-white rounded-t-[30px] px-6 pt-12 pb-8 relative flex flex-col justify-between'>
                ...
                <Image src={'/icons/circularPeopleNearby.svg'} width={150} height={150} alt="filter" className='mx-auto' />

                <div className='text-center space-y-6'>
                    <h3 className="font-bold text-[27px]">People Nearby</h3>
                    <div className='space-y-4'>
                        <p className='text-[#857889]'>You can quickly contact those who are near you and have entered this section, as well as find local groups.</p>
                        <p className='text-[#857889]'>To do this, you need to allow the application to access the location.</p>
                    </div>
                </div>
